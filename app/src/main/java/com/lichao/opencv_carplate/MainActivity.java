...
public class MainActivity extends AppCompatActivity {
    ...
    private int index = 0;
    private int[] ids = {R.drawable.test100,R.drawable.test200,R.drawable.test66,R.drawable.test1, R.drawable.test2, R.drawable.test3, R.drawable.test4,
            R.drawable.test5,R.drawable.test6,R.drawable.test7,R.drawable.test8,R.drawable.test9,R.drawable.test10,R.drawable.test11};
...
//            训练ann字符识别模型耗时: 63.18750 ,保存: HOG_ANN_DATA.xml
    ...
    private void matches(){
        ...
        BitmapFactory.Options bfoOptions = new BitmapFactory.Options();
        bfoOptions.inScaled = false;
        Bitmap src = BitmapFactory.decodeFile(dir+"/test1.jpg");
        Bitmap dst = BitmapFactory.decodeFile(dir+"/test2.jpg");
        int code = matches(src,dst);
    ...
    public native int matches(Bitmap src, Bitmap dst);
}
